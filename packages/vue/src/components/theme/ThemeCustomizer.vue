...
function setThemeColor(color: Theme["name"]) {
	theme.value = color
}
		...
		<div class="space-y-1.5 pt-6">
			...
			<div class="flex space-x-2 py-1.5">
				<Button
					class="h-8"
					variant="outline"
					:class="{ 'border-foreground border-2': lightMode == 'light' }"
				...
				<Button
					class="h-8"
					variant="outline"
					:class="{ 'border-foreground border-2': lightMode == 'dark' }"
				...
				<Button
					class="h-8"
					variant="outline"
					:class="{ 'border-foreground border-2': lightMode == 'auto' }"
